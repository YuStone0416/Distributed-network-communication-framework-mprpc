...
/* @@protoc_insertion_point(class_definition:fixbug.GetFriendListResponse) */ {
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_friends();
...
inline ::std::string* PROTOBUF_NONNULL GetFriendListResponse::add_friends()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline ::std::string* PROTOBUF_NONNULL GetFriendListResponse::mutable_friends(int index)
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponse.friends)
  return _internal_mutable_friends()->Mutable(index);
}
template <typename Arg_, typename... Args_>
inline void GetFriendListResponse::set_friends(int index, Arg_&& value, Args_... args) {
  ::google::protobuf::internal::AssignToString(*_internal_mutable_friends()->Mutable(index), ::std::forward<Arg_>(value),
                        args... , ::google::protobuf::internal::BytesTag{});
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListResponse.friends)
}
template <typename Arg_, typename... Args_>
inline void GetFriendListResponse::add_friends(Arg_&& value, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline const ::google::protobuf::RepeatedPtrField<::std::string>& GetFriendListResponse::friends()
